...
// Find/access/read an elenemt at the position - str[index]
...
// Insert/s the element at a position of the string - splice(elem, 0)
...
// Copy string - slice()
console.log("Cut element/s from and to position, copy string");


// Loop through the string
console.log("Loop through the string");
